...
# .RDS format
rds_obj <- readRDS('different_data_types/ependymal_cells.rds')
...
nsclc.sparse.m <- Read10X_h5(filename = 'different_data_types/20k_NSCLC_DTC_3p_nextgem_Multiplex_count_raw_feature_bc_matrix.h5')
str(nsclc.sparse.m)
...
```{r, eval=FALSE}
# BiocManager::install(c("ExperimentHub", "DESeq2", "SingleCellExperiment"))
