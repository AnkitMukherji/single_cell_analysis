...
res <- query(eh, c("celldex", "Human", "Primary")) # EH3492 logcounts, EH3493 colData
query(eh, c("celldex", "Database", "Immune")) # EH3488 logcounts, EH3489 colData

# https://experimenthub.bioconductor.org/fetch/3508
# https://experimenthub.bioconductor.org/fetch/3508
hpca_assay <- readRDS("C:/path/to/hpca_assay.rds")
hpca_meta  <- readRDS("C:/path/to/hpca_meta.rds")
