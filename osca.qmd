...
saveRDS(sce.pbmc, "OSCA/datasets/OSCA_Basics/sce.pbmc.rds")
sce.pbmc <- readRDS("OSCA/datasets/OSCA_Basics/sce.pbmc.rds")
...
- **Graph-based clustering:**
    ...
    - **Disadvantages:**
        ...
        - The resolution of clustering becomes dependent on the density of cells, which can occasionally be misleading if it overstates the heterogeneity in the data. For example, more steps through the graph are required to move the same distance through a region of higher cell density.
